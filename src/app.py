...
app.layout = html.Div(
    children=[
        ...
        '''), html.A('в моем телеграмме', href='https://t.me/kiradas', target='_blank')
    ]),
    html.Div([
        dcc.Markdown('''Я немного отредактировал определенно некорректные данные (общее число показателя меньше, чем его положительные составляющие). Данный инструмент полностью бесплатен и 
